...
(function($) {
    ...
    $.fn.rProgressbar = function(options) {
        options = $.extend({ percentage: null, ShowProgressCount: true, duration: 2000, fillBackgroundColor: '#201f24', backgroundColor: 'transparent', borderRadius: '10px', height: '7px', width: '100%' }, options);
        $.options = options;
